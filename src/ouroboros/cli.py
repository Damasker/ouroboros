...
SCENARIO_CONFIGS = {
    ...
    "oned-roe": "configs/oned_roe.yaml",
    "oned-wave-mhd": "configs/oned_wave_mhd.yaml",
    "dt-blanket-mc": "configs/dt_blanket_mc.yaml",
    "nozzle-trajectory": "configs/nozzle_trajectory.yaml",
    "oned-hlld": "configs/oned_hlld.yaml",
    "dt-blanket-zones": "configs/dt_blanket_zones.yaml",
    "orbit-3dof": "configs/orbit_3dof.yaml",
